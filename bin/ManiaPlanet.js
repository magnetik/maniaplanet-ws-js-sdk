...
(function() {
  ...
  Rankings = (function(_super) {
    ...
    function Rankings(environment, kind) {
      this.environment = environment;
      this.kind = kind;
    }

    Rankings.prototype.getPlayer = function(login) {
      return execute('get', this.environment + "/rankings/" + this.kind + ("/player/" + login));
    };

    Rankings.prototype.getWorld = function(offset, length) {
      if (offset == null) {
        offset = 0;
      }
      if (length == null) {
      ...
      return execute('get', this.environment + "/rankings/" + this.kind + ("/zone/?offset=" + offset + "&length=" + length));
    };

    Rankings.prototype.getZone = function(path, offset, length) {
      if (offset == null) {
        offset = 0;
      }
      if (length == null) {
      ...
      return execute('get', this.environment + "/rankings/" + this.kind + ("/zone/" + path + "/?offset=" + offset + "&length=" + length));
    };

    Rankings.prototype.getChallengeWorld = function(challengeuid, offset, length) {
      if (offset == null) {
        offset = 0;
      }
      if (length == null) {
      ...
      if (this.kind = 'solo') {
        return execute('get', this.environment + ("/rankings/solo/challenges/" + challengeuid + "/?offset=" + offset + "&length=" + length));
      }
    };

    Rankings.prototype.getChallengeZone = function(challengeuid, path, offset, length) {
      if (offset == null) {
        offset = 0;
      }
      if (length == null) {
      ...
      if (this.kind = 'solo') {
        return execute('get', this.environment + ("/rankings/solo/challenges/" + challengeuid + "/" + path + "/?offset=" + offset + "&length=" + length));
      }
    };
